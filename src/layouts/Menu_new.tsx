...
const AppMenu = ({ menuItems, onMenuItemClick }: AppMenuProps) => {
    ...
    const Navigate: NavigateTypes[] = [
        ...
        ...(['claim_ins', 'claim_upd', 'claim_del'].some((perm) => userRights[perm] || userRole === 'Admin')
            ...
            : []),
        ...(['staff_leave_ins', 'staff_leave_upd', 'staff_leave_del'].some((perm) => userRights[perm] || userRole === 'Admin')
            ? [
                {
                    label: 'Staff Leave',
                    isTitle: false,
            ...
            : []),
        ...(['staff_attendance_ins', 'staff_attendance_upd', 'staff_attendance_del'].some((perm) => userRights[perm] || userRole === 'Admin')
            ? [
        ...
        ...(['visit_entry_ins', 'visit_entry_upd', 'visit_entry_del'].some((perm) => userRights[perm] || userRole === 'Admin')
            ? [
                {
                    label: 'Visit Entry',
                    isTitle: false,
            ...
            : []),
        ...(['petrol_allowance_ins', 'petrol_allowance_upd', 'petrol_allowance_del'].some((perm) => userRights[perm] || userRole === 'Admin')
            ? [
                {
