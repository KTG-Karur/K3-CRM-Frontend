...
const initialState = {
    ...
    getStaffAttendanceReportSuccess: false,
    getStaffAttendanceReportFailure: false,
...
export default function StaffAttendanceReducer(state = initialState, action: any) {
    switch (action.type) {
        ...
        case 'GET_STAFF_ATTENDANCE_REPORT_SUCCESS': {
            return {
                ...state,
                getStaffAttendanceReportSuccess: true,
                getStaffAttendanceReportList: action.payload.data.data,
                getStaffAttendanceReportFailure: false,
            };
        }
        case 'GET_STAFF_ATTENDANCE_REPORT_FAILURE': {
            return {
                ...state,
                getStaffAttendanceReportFailure: true,
                errorMessage: action.errorMessage.errorMessage,
                getStaffAttendanceReportSuccess: false,
            };
        }
        case 'RESET_GET_STAFF_REPORT_ATTENDANCE': {
            return {
                ...state,
                getStaffAttendanceReportSuccess: false,
                getStaffAttendanceReportFailure: false,
