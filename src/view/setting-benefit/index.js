...
import { createSettingBenefitRequest, getActivityRequest, getSettingBenefitRequest, resetCreateSettingBenefit, resetGetActivity, resetGetSettingBenefit, resetUpdateSettingBenefit, updateSettingBenefitRequest } from '../../redux/actions';
...
function Index() {
    ...
    const { getSettingBenefitSuccess, getSettingBenefitList, getSettingBenefitFailure,
        getActivitySuccess, getActivityList, getActivityFailure,
        createSettingBenefitSuccess, createSettingBenefitData, createSettingBenefitFailure,
        updateSettingBenefitSuccess, updateSettingBenefitData, updateSettingBenefitFailure,
        errorMessage,
